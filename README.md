...
![SQLAlchemy](https://img.shields.io/badge/SQLAlchemy-BA5F1D?style=flat-square&logo=sqlalchemy&logoColor=white)
...
![Bcrypt](https://img.shields.io/badge/Bcrypt-003B57?style=flat-square&logo=security&logoColor=white)
...
| [bubble-brews](https://github.com/huseyinky40/bubble-brews) | Physics-based color-matching game with particle systems, collision detection & 10 progressive levels — Computer Graphics course project | HTML5 Canvas · JavaScript · Web Audio API |
...
* Network Programming
* Web Development (Full-stack with FastAPI & React)
* Authentication & Security (JWT, Bcrypt, SMTP)
